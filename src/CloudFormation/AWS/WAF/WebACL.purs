...
-- | `AWS::WAF::WebACL.ActivatedRule`http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-waf-webacl-rules.html-- |
-- | - `Action`
...
-- | `AWS::WAF::WebACL.WafAction`http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-waf-webacl-action.html-- |
-- | - `Type`
